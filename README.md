...
* в **styles** хранятся стили для подключения шрифтов, глобальные стили, различные переменные проекта, а так же миксины.
### Структура блока
```
| | |    ...
| | |-dropdown
...
* блок может иметь файл **const.js**, в котором будут храниться константы селекторов, классов, атрибутов и прочие;
...
* **component.pug** файл содержит не миксин, а разметку страницы;
